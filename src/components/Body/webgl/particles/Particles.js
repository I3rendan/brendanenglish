...
import vert from '!!glslify-import-loader!raw-loader!glslify-loader!../../shaders/particle.vert';
import frag from '!!glslify-import-loader!raw-loader!glslify-loader!../../shaders/particle.frag';
...
export default class Particles {
	...
	show(time = 1.0) {
		// reset
		TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 0.5 }, { value: 0.85 });
